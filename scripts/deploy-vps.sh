...
REPO_URL="$3"
BRANCH="${4:-main}"
APP_DIR="/opt/badge-creator"
LOCAL_APP_HOST_PORT="${APP_HOST_PORT:-8789}"
REPO_HOST=""
...
if [[ -f "${APP_DIR}/docker-compose.prod.yml" ]]; then
  sudo APP_HOST_PORT="${LOCAL_APP_HOST_PORT}" docker compose -f "${APP_DIR}/docker-compose.prod.yml" up -d --force-recreate
